...
async def on_message(message):
    ...
    if (message.content.split()[0]=="!역할지급")&(str(message.channel)=="역할_요청"):
        ...
        if (message.content=="!me"):
            ...
            await message.channel.send(str(message.author.menton)+str(message.content.split(maxsplit=1)[1]))
...
client.run("Njk3NzMxMjIwNTgyMTcwNjg2."+"Xo_bIg.mJ6UghnwfX_MRYPkzFK12onEG28")
